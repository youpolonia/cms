...
function cms_emit_security_headers(): void {
    ...
    header("Content-Security-Policy: default-src 'self'; img-src 'self' data: blob: https: http:; media-src 'self' https: blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tiny.cloud https://unpkg.com https://cdnjs.cloudflare.com; frame-src 'self' https://www.youtube.com https://player.vimeo.com https://maps.google.com https://*.google.com https://www.openstreetmap.org; frame-ancestors 'self'; font-src 'self' https://fonts.gstatic.com https://fonts.googleapis.com https://cdnjs.cloudflare.com data:; connect-src 'self' https://cdn.tiny.cloud https://sp.tinymce.com https:");
