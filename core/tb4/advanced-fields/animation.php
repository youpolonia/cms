...
class Animation extends AdvancedField
{
    ...
    public function generate_css(string $selector, array $values): string
    {
        ...
        // Map animation types to CSS keyframe names
        $keyframe_map = [
            'fade' => 'fade-in',
            'fade-out' => 'fade-out',
            'slide-up' => 'slide-up',
        ...
        // Build animation shorthand with mapped keyframe name
        $keyframe_name = $keyframe_map[$type] ?? $type;
        $animation_name = 'tb4-' . $keyframe_name;
