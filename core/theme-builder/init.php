...
function tb_register_builtin_modules(): void
{
    ...
    // Gallery module - Advanced gallery with lightbox, hover effects, animations
    ...
    // Social Follow module - Social network follow icons with brand colors
    // SEPARATE from 'social' module - this is for follow buttons with brand styling
    tb_register_module('social_follow', [
        'name' => 'Social Follow',
        'icon' => 'social',
        'category' => 'social',
        'defaults' => [
