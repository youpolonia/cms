...
<head>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Shop module */
    .tb4-canvas[data-device="mobile"] .tb4-shop-preview > div {
        grid-template-columns: 1fr !important;
    }
    .tb4-canvas[data-device="tablet"] .tb4-shop-preview > div {
        grid-template-columns: repeat(2, 1fr) !important;
    }
    ...
    /* Video Slider Module */
    .tb4-video-slider-preview {
        position: relative;
        overflow: hidden;
        background: #000;
    }
    .tb4-video-slider-track {
        display: flex;
    ...
    .tb4-video-slide-info {
        padding: 16px;
        background: #111;
    }
    .tb4-video-slide-title {
        font-size: 18px;
        font-weight: 600;
        color: #fff;
        margin: 0 0 4px 0;
    }
    .tb4-video-slide-desc {
        font-size: 14px;
        color: #9ca3af;
        margin: 0;
    }
    .tb4-video-slider-arrows {
        position: absolute;
        top: 50%;
        left: 0;
        right: 0;
    ...
    .tb4-video-slider-arrow:hover {
        background: rgba(0,0,0,0.7);
    }
    .tb4-video-slider-dots {
        position: absolute;
        bottom: 80px;
        left: 0;
        right: 0;
    ...
    .tb4-video-slider-dot:hover {
        background: rgba(255,255,255,0.8);
    }
    .tb4-video-slider-dot.active {
        background: #fff;
    }
...
<body>
    ...
    /* ═══════════════════════════════════════════════════════════════════
       TB4 Post Slider Module Styles
       ═══════════════════════════════════════════════════════════════════ */
       TB4 Bar Counter Module Styles
       ═══════════════════════════════════════════════════════════════════ */
    .tb4-bar-counter-preview {
        display: flex;
        flex-direction: column;
    }
    ...
    .tb4-bar-percent-inside {
        font-size: 12px;
        font-weight: 600;
        color: #fff;
    }

    .tb4-bar-fill.striped {
        background-image: linear-gradient(
            45deg,
            rgba(255,255,255,0.15) 25%,
            transparent 25%,
    ...
    .tb4-shop-card.hover-lift:hover {
    ...
    .tb4-shop-card-image img,
    .tb4-shop-card-image-placeholder {
        width: 100%;
        height: 100%;
        object-fit: cover;
        transition: transform 0.3s ease;
    }
    .tb4-shop-card.hover-zoom:hover .tb4-shop-card-image img,
    .tb4-shop-card.hover-zoom:hover .tb4-shop-card-image-placeholder {
        transform: scale(1.1);
    }
    .tb4-shop-sale-badge {
        position: absolute;
    ...
    .tb4-shop-price-current {
        font-size: 18px;
        font-weight: 700;
        color: #111827;
    }
    .tb4-shop-price-original {
        font-size: 14px;
        color: #9ca3af;
    ...
    .tb4-shop-add-btn:hover {
        background: #1d4ed8;
    }
    .tb4-shop-add-btn.full-width {
        width: 100%;
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════
       TB4 Post Slider Module Styles
       ═══════════════════════════════════════════════════════════════════ */
       TB4 Filterable Portfolio Module Styles
       ═══════════════════════════════════════════════════════════════════ */
    .tb4-filter-portfolio-preview {
        width: 100%;
    }
    ...
    .tb4-filter-btn.active {
        background: #2563eb;
        color: #fff;
    }

    .tb4-filter-btn.style-underline {
        background: transparent;
        border-radius: 0;
        border-bottom: 2px solid transparent;
        padding: 8px 16px;
    ...
    .tb4-filter-btn.style-underline.active {
        background: transparent;
        color: #2563eb;
    ...
    .tb4-filter-item.hidden {
        display: none;
    }

    .tb4-filter-item-inner {
        width: 100%;
        height: 100%;
        background-size: cover;
        background-position: center;
    ...
    .tb4-filter-item:hover .tb4-filter-item-overlay {
        opacity: 1;
    }

    .tb4-filter-item-title {
        font-size: 18px;
        font-weight: 600;
        color: #fff;
        margin: 0 0 4px 0;
