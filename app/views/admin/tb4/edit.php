...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/tb4/design-system.css?v=20260111">
    <link rel="stylesheet" href="/assets/tb4/css/builder.css?v=20260111">
    <link rel="stylesheet" href="/assets/tb4/css/settings-sidebar.css?v=20260113">
    <link rel="stylesheet" href="/assets/tb4/css/fields.css?v=20260111">
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .tb4-library-item:hover {
        border-color: #89b4fa;
        transform: translateY(-2px);
    }
    .tb4-library-item-preview {
        aspect-ratio: 16/10;
        background: #181825;
        display: flex;
        align-items: center;
    ...
    .tb4-library-item-info {
        padding: 12px;
    }
    .tb4-library-item-name {
        font-weight: 600;
        color: #cdd6f4;
        margin-bottom: 4px;
    }
    .tb4-library-item-meta {
        font-size: 12px;
        color: #6c7086;
    }
    .tb4-library-loading {
    ...
    /* Layout Library Modal Enhanced */
    /* Override builder.css white background */
    .tb4-library-modal.tb4-modal {
        background: transparent !important;
        max-width: none !important;
        width: auto !important;
    }
    .tb4-library-modal .tb4-modal-content {
        background: #1e1e2e !important;
        border: 1px solid #313244;
        border-radius: 12px;
        min-width: 700px;
    ...
    .tb4-library-filters select,
    .tb4-library-filters input {
        background: #313244;
    ...
    .tb4-library-filters select:focus,
    .tb4-library-filters input:focus {
        border-color: #89b4fa;
        outline: none;
    }
    ...
    .tb4-library-empty p:first-of-type {
        font-size: 16px;
        color: #a6adc8;
        margin-bottom: 8px;
    }

    .tb4-library-empty p:last-of-type {
        font-size: 13px;
    }
    ...
    /* Save form styles */
    .tb4-library-save-form {
        max-width: 400px;
    }

    .tb4-library-save-form .tb4-form-group {
        margin-bottom: 16px;
    }

    .tb4-library-save-form label {
        display: block;
        color: #cdd6f4;
        margin-bottom: 6px;
        font-size: 14px;
    ...
    .tb4-library-save-form input,
    .tb4-library-save-form select {
        width: 100%;
        background: #313244;
        border: 1px solid #45475a;
        color: #cdd6f4;
    ...
    .tb4-library-save-form input:focus,
    .tb4-library-save-form select:focus {
        border-color: #89b4fa;
        outline: none;
    }

    .tb4-library-save-form .tb4-btn-group {
        display: flex;
        gap: 12px;
        margin-top: 24px;
    }
    ...
    /* ═══════════════════════════════════════════════════════════════════════════
       TB4 DESIGN CONTROLS - Divi-Style Professional UI
       ═══════════════════════════════════════════════════════════════════════════ */

    /* Collapsible Section */
    .tb4-collapsible-section {
        background: var(--tb4-surface, #1e293b);
        border: 1px solid var(--tb4-border-default, #334155);
        border-radius: 8px;
        margin-bottom: 12px;
        overflow: hidden;
    }
    ...
    .tb4-section-header:hover {
        background: rgba(255, 255, 255, 0.05);
    }

    .tb4-section-icon {
        font-size: 10px;
        color: var(--tb4-text-muted, #64748b);
    ...
    .tb4-section-title {
        ...
        font-weight: 600;
        font-size: 13px;
        color: var(--tb4-text-primary, #e2e8f0);
        text-transform: uppercase;
    ...
    /* Combined Spacing Box (Divi-style margin/padding) */
    .tb4-spacing-box-container {
        padding: 16px;
    }

    .tb4-spacing-box-outer {
        position: relative;
    ...
    .tb4-spacing-content-center {
        background: var(--tb4-surface, #1e293b);
        border-radius: 4px;
        min-height: 40px;
    }

    .tb4-spacing-label-margin,
    .tb4-spacing-label-padding {
        position: absolute;
        font-size: 9px;
        font-weight: 700;
        text-transform: uppercase;
    ...
    .tb4-spacing-box-input:focus {
        outline: none;
        border-color: #3b82f6;
        box-shadow: 0 0 0 2px rgba(59, 130, 246, 0.2);
    }

    .tb4-spacing-box-input::placeholder {
        color: var(--tb4-text-muted, #64748b);
        opacity: 0.6;
    }

    /* Margin inputs positioning */
    .tb4-spacing-box-outer > .tb4-margin-top { top: 8px; left: 50%; transform: translateX(-50%); }
    .tb4-spacing-box-outer > .tb4-margin-right { right: 8px; top: 50%; transform: translateY(-50%); }
    .tb4-spacing-box-outer > .tb4-margin-bottom { bottom: 8px; left: 50%; transform: translateX(-50%); }
    .tb4-spacing-box-outer > .tb4-margin-left { left: 8px; top: 50%; transform: translateY(-50%); }

    /* Padding inputs positioning */
    .tb4-spacing-box-inner > .tb4-padding-top { top: 6px; left: 50%; transform: translateX(-50%); }
    .tb4-spacing-box-inner > .tb4-padding-right { right: 6px; top: 50%; transform: translateY(-50%); }
    .tb4-spacing-box-inner > .tb4-padding-bottom { bottom: 6px; left: 50%; transform: translateX(-50%); }
    .tb4-spacing-box-inner > .tb4-padding-left { left: 6px; top: 50%; transform: translateY(-50%); }

    /* Link buttons for spacing */
    .tb4-spacing-link-btn {
        position: absolute;
        width: 26px;
        height: 26px;
        border: none;
    ...
    .tb4-spacing-link-btn:hover {
        background: var(--tb4-surface-hover, #334155);
        box-shadow: 0 3px 8px rgba(0,0,0,0.4);
    }

    .tb4-spacing-link-btn.linked {
        background: #3b82f6;
        color: white;
    }

    .tb4-spacing-link-padding {
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
        z-index: 11;
    ...
    .tb4-spacing-link-margin {
        top: 6px;
        right: 6px;
        transform: none;
    }

    /* Border Settings Controls */
    .tb4-border-controls-grid {
        display: grid;
        gap: 12px;
    }

    .tb4-border-width-box {
        position: relative;
        width: 120px;
        height: 100px;
        margin: 16px auto;
        background: var(--tb4-surface, #1e293b);
        border-radius: 8px;
        border: 2px solid var(--tb4-border-default, #334155);
    }

    .tb4-border-width-box .tb4-border-input {
        position: absolute;
    }

    .tb4-border-width-box .tb4-border-input.top { top: -10px; left: 50%; transform: translateX(-50%); }
    .tb4-border-width-box .tb4-border-input.right { right: -10px; top: 50%; transform: translateY(-50%); }
    .tb4-border-width-box .tb4-border-input.bottom { bottom: -10px; left: 50%; transform: translateX(-50%); }
    .tb4-border-width-box .tb4-border-input.left { left: -10px; top: 50%; transform: translateY(-50%); }

    .tb4-border-width-box .tb4-border-input input {
        width: 40px;
        padding: 4px;
        text-align: center;
        font-size: 11px;
    ...
    .tb4-border-width-box .tb4-border-center {
        position: absolute;
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
    ...
    .tb4-radius-box .tb4-radius-input {
        position: absolute;
    }

    .tb4-radius-box .tb4-radius-input.tl { top: -10px; left: -10px; }
    .tb4-radius-box .tb4-radius-input.tr { top: -10px; right: -10px; }
    .tb4-radius-box .tb4-radius-input.br { bottom: -10px; right: -10px; }
    .tb4-radius-box .tb4-radius-input.bl { bottom: -10px; left: -10px; }

    .tb4-radius-box .tb4-radius-input input {
        width: 40px;
        padding: 4px;
        text-align: center;
        font-size: 11px;
    ...
    .tb4-radius-box .tb4-radius-center {
        position: absolute;
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
    ...
    .tb4-control-row label {
        flex: 0 0 100px;
        font-size: 12px;
        color: var(--tb4-text-muted, #64748b);
    }

    .tb4-control-row .tb4-input,
    .tb4-control-row .tb4-select {
        flex: 1;
    }

    .tb4-control-row.slider {
        flex-direction: column;
        align-items: stretch;
    }

    .tb4-control-row.slider label {
        flex: none;
        display: flex;
        justify-content: space-between;
        margin-bottom: 6px;
    ...
    /* Linked Spacing Visual Control */
    .tb4-linked-spacing-control {
        margin-bottom: 16px;
    }
    ...
    .tb4-spacing-row.tb4-spacing-middle {
        width: 100%;
        justify-content: space-between;
    }
    ...
    .tb4-spacing-preview {
        ...
        height: 40px;
        background: var(--tb4-surface, #1e293b);
        border: 2px dashed var(--tb4-border-default, #334155);
        border-radius: 4px;
    }
    ...
    /* Position offsets */
    .tb4-position-offsets {
        margin-top: 12px;
    }

    /* Animation presets */
    .tb4-animation-presets {
        display: flex;
        flex-wrap: wrap;
        gap: 8px;
        margin-bottom: 12px;
    ...
    .tb4-animation-preset:hover {
        border-color: #3b82f6;
        color: var(--tb4-text-primary, #e2e8f0);
    }

    .tb4-animation-preset.active {
        background: #3b82f6;
        border-color: #3b82f6;
        color: white;
    }
    ...
    .tb4-btn-group .tb4-btn-sm {
        padding: 8px 12px;
        font-size: 14px;
    }

    .tb4-btn-group .tb4-btn-sm.active {
        background: #3b82f6;
        color: white;
    }

    /* Tabs in settings */
    .tb4-tabs .tb4-tab-buttons {
        display: flex;
        gap: 4px;
        margin-bottom: 12px;
    }
    ...
    .tb4-field-responsive .tb4-field-header {
        display: flex;
        align-items: center;
        justify-content: space-between;
        margin-bottom: 8px;
...
<body>
    ...
    <div class="tb4-toolbar" id="tb4-toolbar">
        ...
        <div class="tb4-toolbar-section tb4-toolbar-right">
            ...
            <button type="button" class="tb4-btn" id="tb4-library-btn" title="Layout Library">
                    ...
                    <div class="tb4-panel tb4-modules-panel active" data-sidebar-content="modules" id="tb4-module-list">
                        ...
                        <div class="tb4-module-category" data-category="content">
                            ...
                            <div class="tb4-modules-grid">
                                ...
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_social_item">
                                    <i data-lucide="share-2" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Social Link</div>
                                </div>
                                ...
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_signup_item">
                                    <i data-lucide="user-plus" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Signup Field</div>
                                </div>
                                ...
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_bar_counter_item">
                                    <i data-lucide="minus" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Bar Item</div>
                                </div>
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_filter_portfolio">
                                    <i data-lucide="filter" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Filterable Portfolio</div>
                                </div>
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_map">
                                    <i data-lucide="map-pin" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Map</div>
                                </div>
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_map_item">
                                    <i data-lucide="map-pin" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Map Pin</div>
                                </div>
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_menu">
                                    <i data-lucide="menu" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Menu</div>
                                </div>
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_sidebar">
                                    <i data-lucide="panel-left" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Sidebar</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tb4-module-category" data-category="media">
                            ...
                            <div class="tb4-modules-grid">
                                ...
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_video_slider">
                                    <i data-lucide="film" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Video Slider</div>
                                </div>
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_video_slider_item">
                                    <i data-lucide="film" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Video Slide</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tb4-module-category" data-category="interactive">
                            ...
                            <div class="tb4-modules-grid">
                                ...
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_contact_item">
                                    <i data-lucide="text-cursor-input" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Form Field</div>
                                </div>
                        ...
                        <div class="tb4-module-category" data-category="commerce">
                            ...
                            <div class="tb4-modules-grid">
                                ...
                                <div class="tb4-module-item" draggable="true" data-module-type="tb4_shop">
                                    <i data-lucide="shopping-bag" class="tb4-module-icon"></i>
                                    <div class="tb4-module-name">Shop</div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- TB4 UI Fix CSS -->
    <link rel="stylesheet" href="/assets/tb4/css/tb4-ui-fix.css?v=20260111content">
    <!-- TB4 Field Controls -->
    <script src="/assets/tb4/js/fields.js?v=20260111content" defer></script>

    <!-- External Builder JS (cache-busted) -->
    <script src="/assets/tb4/js/builder.js?v=20260113fix" defer></script>
    ...
    <!-- Layout Library Modal -->
    <div id="tb4-library-modal" class="tb4-modal tb4-library-modal" style="display:none;">
        <div class="tb4-modal-overlay" data-close-modal></div>
        <div class="tb4-modal-content">
            <div class="tb4-modal-header">
                <h3 class="tb4-modal-title">Layout Library</h3>
                <button type="button" class="tb4-modal-close" data-close-modal>
                    <i data-lucide="x"></i>
                </button>
            </div>
            <div class="tb4-modal-tabs">
                <button type="button" class="tb4-tab-btn active" data-tab="load">Load Layout</button>
                <button type="button" class="tb4-tab-btn" data-tab="save">Save to Library</button>
            </div>
            <div class="tb4-modal-body" style="overflow-y:auto;max-height:calc(80vh - 140px);">
                <!-- Load Tab -->
                <div id="tb4-library-load-tab" class="tb4-tab-content active">
                    <div class="tb4-library-filters" style="display:flex;gap:12px;margin-bottom:16px;">
                        <select id="tb4-library-type-filter" class="tb4-select" style="flex:1;">
                        ...
                        <select id="tb4-library-category-filter" class="tb4-select" style="flex:1;">
                            <option value="">All Categories</option>
                        </select>
                        <input type="text" id="tb4-library-search" class="tb4-input" placeholder="Search layouts..." style="flex:2;">
                    </div>
                    <div id="tb4-library-grid" class="tb4-library-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;">
                        <!-- Layouts loaded via JS -->
                        <div class="tb4-library-loading" style="grid-column:1/-1;text-align:center;padding:40px;color:#6b7280;">
                ...
                <!-- Save Tab -->
                <div id="tb4-library-save-tab" class="tb4-tab-content" style="display:none;">
                    <div class="tb4-form-group" style="margin-bottom:16px;">
                        <label class="tb4-label">Layout Name *</label>
                        <input type="text" id="tb4-save-layout-name" class="tb4-input" placeholder="Enter layout name" required>
                    </div>
                    <div class="tb4-form-group" style="margin-bottom:16px;">
                        <label class="tb4-label">Type *</label>
                        <select id="tb4-save-layout-type" class="tb4-select">
                            <option value="page">Full Page</option>
                    ...
                    <div class="tb4-form-group" style="margin-bottom:16px;">
                        <label class="tb4-label">Category</label>
                        <input type="text" id="tb4-save-layout-category" class="tb4-input" placeholder="e.g., Headers, Footers, Hero sections">
                    </div>
                    <div class="tb4-form-actions" style="display:flex;justify-content:flex-end;gap:12px;margin-top:24px;">
                        <button type="button" class="tb4-btn tb4-btn-secondary" data-close-modal>Cancel</button>
                        <button type="button" class="tb4-btn tb4-btn-primary" id="tb4-save-to-library-btn">
                            <i data-lucide="save"></i> Save to Library
                        </button>
                    </div>
                </div>
            </div>
    ...
    (function() {
        const libraryBtn = document.getElementById('tb4-library-btn');
        const libraryModal = document.getElementById('tb4-library-modal');
        const libraryGrid = document.getElementById('tb4-library-grid');
        const typeFilter = document.getElementById('tb4-library-type-filter');
        const categoryFilter = document.getElementById('tb4-library-category-filter');
        const searchInput = document.getElementById('tb4-library-search');
        const saveBtn = document.getElementById('tb4-save-to-library-btn');
        ...
        document.querySelectorAll('[data-close-modal]').forEach(el => {
            el.addEventListener('click', function() {
                this.closest('.tb4-modal').style.display = 'none';
            });
        });

        // Tab switching
        document.querySelectorAll('.tb4-tab-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                const tab = this.dataset.tab;
                document.querySelectorAll('.tb4-tab-btn').forEach(b => b.classList.remove('active'));
                document.querySelectorAll('.tb4-tab-content').forEach(c => c.style.display = 'none');
                this.classList.add('active');
                document.getElementById('tb4-library-' + tab + '-tab').style.display = 'block';
            });
        });

        // Load library items from API
        async function loadLibraryItems() {
            libraryGrid.innerHTML = '<div class="tb4-library-loading"><i data-lucide="loader-2" class="spin"></i><p>Loading layouts...</p></div>';
            if (typeof lucide !== 'undefined') lucide.createIcons();
            ...
            try {
                ...
                const response = await fetch('/admin/tb4/api?action=get_library_items&' + params.toString());
                ...
                if (data.success) {
                    ...
                    libraryGrid.innerHTML = '<div class="tb4-library-error"><i data-lucide="alert-circle"></i><p>Error loading layouts</p></div>';
                    if (typeof lucide !== 'undefined') lucide.createIcons();
                }
            } catch (err) {
                console.error('[TB4 Library] Load error:', err);
                libraryGrid.innerHTML = '<div class="tb4-library-error"><i data-lucide="alert-circle"></i><p>Failed to load layouts</p></div>';
                if (typeof lucide !== 'undefined') lucide.createIcons();
            }
        }
        ...
        function renderLibraryItems() {
            if (libraryItems.length === 0) {
                libraryGrid.innerHTML = '<div class="tb4-library-empty"><i data-lucide="inbox"></i><p>No layouts found</p><p>Save your first layout using the "Save to Library" tab</p></div>';
                if (typeof lucide !== 'undefined') lucide.createIcons();
                return;
            }

            libraryGrid.innerHTML = libraryItems.map(item => `
                <div class="tb4-library-item" data-id="${item.id}" data-type="${item.type}">
                    <div class="tb4-library-item-preview">
                        <i data-lucide="${getTypeIcon(item.type)}" style="width:32px;height:32px;"></i>
                    </div>
                    <div class="tb4-library-item-info">
                        <div class="tb4-library-item-name">${escapeHtml(item.name)}</div>
                        <div class="tb4-library-item-meta">
                            <span>${item.type}</span>
            ...
            libraryGrid.querySelectorAll('.tb4-library-item').forEach(el => {
                el.addEventListener('click', () => loadLayoutItem(el.dataset.id, el.dataset.type));
            });
        }

        function getTypeIcon(type) {
            const icons = { page: 'file', section: 'square', row: 'columns', module: 'box' };
        ...
        // Load a layout item into canvas
        async function loadLayoutItem(id, type) {
            if (!confirm('Load this layout? Current unsaved changes will be replaced.')) return;

            try {
                const response = await fetch('/admin/tb4/api?action=get_library_item&id=' + id);
                const data = await response.json();

                if (data.success && data.item) {
                    const content = JSON.parse(data.item.content_json || '{}');

                    if (type === 'page' && typeof TB4Builder !== 'undefined') {
                        TB4Builder.loadContent(content);
                    } else if (type === 'section' && typeof TB4Builder !== 'undefined') {
                        TB4Builder.addSection(content);
                    } else if (typeof TB4Builder !== 'undefined' && TB4Builder.insertContent) {
                        TB4Builder.insertContent(content, type);
                    }
                ...
                console.error('[TB4 Library] Load item error:', err);
        ...
        if (saveBtn) {
            saveBtn.addEventListener('click', async function() {
                const name = document.getElementById('tb4-save-layout-name').value.trim();
                const type = document.getElementById('tb4-save-layout-type').value;
                const category = document.getElementById('tb4-save-layout-category').value.trim();
                ...
                if (typeof TB4Builder !== 'undefined') {
                    if (type === 'page') {
                        contentToSave = TB4Builder.getContent();
                    } else if (type === 'section' && TB4Builder.getSelectedSection) {
                        contentToSave = TB4Builder.getSelectedSection();
                    } else if (type === 'row' && TB4Builder.getSelectedRow) {
                        contentToSave = TB4Builder.getSelectedRow();
                    } else if (type === 'module' && TB4Builder.getSelectedModule) {
                        contentToSave = TB4Builder.getSelectedModule();
                    } else {
                        contentToSave = TB4Builder.getContent();
                    }
                }
                ...
                try {
                    const response = await fetch('/admin/tb4/api', {
                        method: 'POST',
                    ...
                    if (data.success) {
                        showToast('Layout saved to library', 'success');
                        document.getElementById('tb4-save-layout-name').value = '';
                        document.getElementById('tb4-save-layout-category').value = '';
                        loadLibraryItems();
                        // Switch to Load tab
                        document.querySelector('.tb4-tab-btn[data-tab="load"]').click();
                    } else {
                        showToast(data.error || 'Failed to save layout', 'error');
                    }
                } catch (err) {
                    console.error('[TB4 Library] Save error:', err);
        ...
        // Filters
        if (typeFilter) typeFilter.addEventListener('change', loadLibraryItems);
        if (categoryFilter) categoryFilter.addEventListener('change', loadLibraryItems);
        if (searchInput) {
            let searchTimeout;
            searchInput.addEventListener('input', function() {
                clearTimeout(searchTimeout);
                searchTimeout = setTimeout(loadLibraryItems, 300);
            });
        }

        // Toast helper
        function showToast(message, type = 'info') {
            if (window.tb4ShowToast) {
                window.tb4ShowToast(message, type);
            } else {
                const toast = document.createElement('div');
                toast.className = 'tb4-toast tb4-toast-' + type;
                toast.textContent = message;
                toast.style.cssText = 'position:fixed;bottom:20px;right:20px;padding:12px 20px;border-radius:8px;color:white;z-index:10001;animation:fadeIn 0.3s;';
                toast.style.background = type === 'success' ? '#a6e3a1' : type === 'error' ? '#f38ba8' : '#89b4fa';
                toast.style.color = '#1e1e2e';
    ...
    <!-- Settings Sidebar (Etap 5) - Professional Controls Integration -->
    <script src="/assets/tb4/js/settings-sidebar.js?v=20260113-integrated"></script>
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        // Connect Settings Sidebar to TB4Builder
        if (typeof TB4SettingsSidebar !== 'undefined' && typeof TB4Builder !== 'undefined') {

            // Listen for module selection in canvas
            TB4SettingsSidebar.on('save', function(e) {
                console.log('[TB4] Settings saved:', e.detail);
                // Will be implemented in Etap 6
            });

            // Expose to TB4Builder
            TB4Builder.settingsSidebar = TB4SettingsSidebar;
