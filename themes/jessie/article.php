...
<article class="single-article">
    <div class="container">
        <div class="article-header">
            ...
            <a href="/blog?category=<?= htmlspecialchars($article["category_slug"] ?? "") ?>" class="tag"><?= htmlspecialchars($article["category_name"]) ?></a>
            <?php endif; ?>
...
.article-header .tag { display: inline-block; margin-bottom: 20px; padding: 6px 16px; background: var(--accent-primary); color: white; border-radius: 20px; font-size: 0.85rem; text-decoration: none; }
