...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700&amp;family=Cormorant+Garamond:wght@400;500;600;700&amp;display=swap" rel="stylesheet">
            ...
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p class="footer-tagline" data-ts="footer.description">
                        <?= esc(theme_get('footer.description', 'Professional paving and groundwork contractors serving Essex and surrounding areas for over 23 years.')) ?>
                    </p>
                    <div class="footer-social">
                        <a href="https://instagram.com/edispaving" aria-label="Instagram" target="_blank" rel="noopener">
                ...
                <div class="footer-contact">
                    ...
                    <ul class="contact-list">
                        <li>
                            ...
                            <span>70 Broomstick Hall Road<br>Waltham Abbey, EN9 1LR</span>
                        </li>
                        <li>
        ...
        <div class="container">
            <div class="footer-bottom-content">
                ...
                <div class="footer-badges">
                    <span class="badge"><i class="fas fa-shield-alt"></i> Fully Insured</span>
                    <span class="badge"><i class="fas fa-award"></i> 23+ Years</span>
                </div>
            </div>
        </div>
    </div>
