...
<div class="atpl-wrap">
    ...
    <aside class="vcb-articles-sidebar">
    <div class="vcb-sidebar-card">
        <h4 class="vcb-sidebar-title">Search Articles</h4>
        <form class="vcb-sidebar-search" action="/articles" method="GET">
            <div class="vcb-search-field">
                <input type="text" name="q" placeholder="What are you looking for?" class="vcb-search-input">
                <button type="submit" class="vcb-search-btn" aria-label="Search">
    ...
    <div class="vcb-sidebar-card">
        <h4 class="vcb-sidebar-title">Flavor Categories</h4>
        <div class="vcb-sidebar-categories">
            <?php foreach ($categories as $cat): ?>
            <a href="/articles?category=<?= esc($cat['slug']) ?>" class="vcb-category-link">
                <span class="vcb-category-name"><?= esc($cat['name']) ?></span>
                <span class="vcb-category-count"><?= (int)($cat['article_count'] ?? 0) ?></span>
            </a>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <div class="vcb-sidebar-card">
        <h4 class="vcb-sidebar-title">From Our Kitchen</h4>
        <p class="vcb-sidebar-about" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Discover the art behind our 30+ cheesecake flavors, seasonal inspirations, and baking secrets from our master pastry chefs.')) ?>
        </p>
    </div>

    <div class="vcb-sidebar-card">
        <h4 class="vcb-sidebar-title">Stay Updated</h4>
        <p class="vcb-sidebar-newsletter-desc">Get exclusive recipes and seasonal flavor announcements.</p>
        <form class="vcb-sidebar-newsletter">
            <input type="email" placeholder="Your email address" class="vcb-newsletter-input" required>
            <button type="button" class="vcb-newsletter-btn">
                <span>Subscribe</span>
    ...
    <div class="vcb-sidebar-card vcb-sidebar-quote">
        <i class="fas fa-quote-left vcb-quote-icon"></i>
        <blockquote class="vcb-quote-text" data-ts="sidebar.quote">
            <?= esc(theme_get('sidebar.quote', 'A perfect cheesecake is a moment of pure indulgence, crafted with patience and passion.')) ?>
        </blockquote>
        <cite class="vcb-quote-author">– Our Head Pastry Chef</cite>
    </div>
</aside>
</div>