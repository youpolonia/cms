...
<aside class="articles-sidebar">
    ...
    <div class="sidebar-widget about-widget">
        ...
        <p class="about-text" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Tutorials, tips, and insights on building software with AI. From prompt engineering to deployment—we cover it all.')) ?>
        </p>
    </div>
    ...
    <div class="sidebar-widget newsletter-widget">
        ...
        <h4 class="widget-title">Weekly Digest</h4>
        <p class="newsletter-text">AI coding tips delivered every Friday.</p>
        <form class="sidebar-newsletter">
            <input type="email" placeholder="Enter email" class="sidebar-input">
    ...
    <div class="sidebar-widget tags-widget">
        ...
        <div class="tags-cloud">
            <a href="#" class="tag">AI Coding</a>
            <a href="#" class="tag">Prompts</a>
            <a href="#" class="tag">No-Code</a>
            <a href="#" class="tag">MVP</a>
            <a href="#" class="tag">Automation</a>
            <a href="#" class="tag">Startups</a>
        </div>
    </div>
</aside>
        </div>
