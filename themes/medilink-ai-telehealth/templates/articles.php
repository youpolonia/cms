...
<div class="atpl-wrap">
    ...
    <div class="atpl-widget">
        ...
        <form class="atpl-search-form" action="/articles" method="get">
            <input type="text" name="q" class="atpl-search-input" placeholder="Type keywords..." aria-label="Search articles">
            <button type="submit" class="atpl-search-btn" aria-label="Submit search">
    ...
    <div class="atpl-widget">
        ...
        <p class="atpl-widget-text" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Stay informed with the latest in telehealth innovation, AI-driven healthcare, and wellness tips from our team of specialists.')) ?>
        </p>
    </div>
    ...
    <div class="atpl-widget">
        ...
        <p>Get the latest health tech articles and updates delivered to your inbox.</p>
        <form class="atpl-newsletter-form">
            <input type="email" class="atpl-search-input" placeholder="Your email address" aria-label="Email for newsletter">
            <button type="button" class="atpl-btn atpl-btn-primary" onclick="alert('Newsletter signup would be connected to your email service.')">Subscribe</button>
        </form>
    </div>
    ...
    <div class="atpl-widget">
        ...
        <div class="atpl-widget-content">
            <a href="#" class="atpl-recent-link">
                <span>How AI is Transforming Patient Triage</span>
                <small>2 days ago</small>
            </a>
            <a href="#" class="atpl-recent-link">
                <span>The Future of Digital Prescriptions</span>
                <small>1 week ago</small>
            </a>
            <a href="#" class="atpl-recent-link">
                <span>Mental Health Support via Telehealth</span>
    ...
    <div class="atpl-widget">
        ...
        <div class="atpl-social-links">
            <?php if (theme_get('footer.facebook')): ?>
            <a href="<?= esc(theme_get('footer.facebook')) ?>" class="atpl-social-link" target="_blank" rel="noopener" aria-label="Facebook">
                <i class="fab fa-facebook-f"></i>
            </a>
            <?php endif; ?>
            <?php if (theme_get('footer.instagram')): ?>
            <a href="<?= esc(theme_get('footer.instagram')) ?>" class="atpl-social-link" target="_blank" rel="noopener" aria-label="Instagram">
                <i class="fab fa-instagram"></i>
            </a>
            <?php endif; ?>
            <?php if (theme_get('footer.linkedin')): ?>
            <a href="<?= esc(theme_get('footer.linkedin')) ?>" class="atpl-social-link" target="_blank" rel="noopener" aria-label="LinkedIn">
                <i class="fab fa-linkedin-in"></i>
            </a>
            <?php endif; ?>
            <?php if (theme_get('footer.twitter')): ?>
            <a href="<?= esc(theme_get('footer.twitter')) ?>" class="atpl-social-link" target="_blank" rel="noopener" aria-label="Twitter">
