...
<div class="atpl-wrap">
    ...
    <div class="atpl-widget">
        ...
        <form class="atpl-search-form" action="/articles" method="get">
            <input type="text" name="q" placeholder="Type keywords..." class="atpl-search-input" aria-label="Search articles">
    ...
    <div class="atpl-widget">
        ...
        <p class="atpl-widget-content" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Insights on project management, team collaboration, and AI-driven productivity. Stay updated with the latest trends and best practices.')) ?>
        </p>
    </div>
    ...
    <div class="atpl-widget">
        ...
        <p class="atpl-widget-content">Get weekly tips on improving your workflow and team efficiency.</p>
        <form class="atpl-newsletter-form">
            <input type="email" placeholder="Your email address" class="atpl-search-input" aria-label="Email for newsletter">
            <button type="button" class="atpl-search-btn" aria-label="Subscribe">
    ...
    <div class="atpl-widget">
        ...
        <div class="atpl-tags">
            <a href="/articles?tag=kanban" class="atpl-tag">Kanban</a>
            <a href="/articles?tag=ai-planning" class="atpl-tag">AI Planning</a>
            <a href="/articles?tag=gantt" class="atpl-tag">Gantt Charts</a>
            <a href="/articles?tag=remote-work" class="atpl-tag">Remote Work</a>
            <a href="/articles?tag=productivity" class="atpl-tag">Productivity</a>
            <a href="/articles?tag=sprint" class="atpl-tag">Sprint</a>
        </div>
    </div>
</aside>
</div>