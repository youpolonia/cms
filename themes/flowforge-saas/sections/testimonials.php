<?php
$tTitle = theme_get('testimonials.title', 'What Our Clients Say About FlowForge');
...
?>
<section class="fs-testimonials fs-testimonials--cards-minimal" id="testimonials">
  <div class="container">
    <div class="fs-testimonials-header" data-animate="fade-up">
      <h2 class="fs-testimonials-title" data-ts="testimonials.title"><?= esc($tTitle) ?></h2>
      <p class="fs-testimonials-subtitle" data-ts="testimonials.subtitle"><?= esc($tSubtitle) ?></p>
    </div>
    <div class="fs-testimonials-grid">
      <?php foreach ($items as $idx => $item): ?>
      <div class="fs-testimonial-card" data-animate="fade-up">
        <div class="fs-testimonial-stars">
          <?php for ($s = 0; $s < $item['rating']; $s++): ?><i class="fas fa-star"></i><?php endfor; ?>
        </div>
        <blockquote class="fs-testimonial-quote">
          <p data-ts="testimonials.item<?= $idx+1 ?>_quote"><?= esc($item['quote']) ?></p>
        </blockquote>
        <div class="fs-testimonial-author-minimal">
