...
<div class="atpl-wrap">
    ...
    <aside class="nf-articles-sidebar">
    <!-- Search Widget -->
    <div class="nf-sidebar-widget nf-widget-search">
        <h4 class="nf-widget-title">Search Articles</h4>
        <form class="nf-search-form">
            <div class="nf-search-input-group">
                <input type="search" placeholder="Type keywords..." class="nf-search-input">
                <button type="submit" class="nf-search-btn" aria-label="Search">
    ...
    <div class="nf-sidebar-widget nf-widget-categories">
        <h4 class="nf-widget-title">Categories</h4>
        <div class="nf-categories-list">
            <?php foreach ($categories as $cat): ?>
            <a href="/articles?category=<?= esc($cat['slug']) ?>" class="nf-category-link">
                <span class="nf-category-name"><?= esc($cat['name']) ?></span>
                <span class="nf-category-count"><?= (int)($cat['article_count'] ?? 0) ?></span>
            </a>
            <?php endforeach; ?>
        </div>
    </div>
    ...
    <!-- About Blog -->
    <div class="nf-sidebar-widget nf-widget-about">
        <h4 class="nf-widget-title">Freelancer Finance Hub</h4>
        <p class="nf-widget-desc" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Expert insights on managing freelance finances, tax strategies, and leveraging AI tools for smarter banking.')) ?>
        </p>
    </div>

    <!-- Newsletter Signup -->
    <div class="nf-sidebar-widget nf-widget-newsletter">
        <h4 class="nf-widget-title">Get Weekly Insights</h4>
        <p>Join 5,000+ freelancers who receive our financial tips.</p>
        <form class="nf-sidebar-newsletter">
            <input type="email" placeholder="Your email" class="nf-newsletter-input" required>
            <button type="submit" class="nf-newsletter-btn">Subscribe</button>
        </form>
    </div>

    <!-- Popular Tags -->
    <div class="nf-sidebar-widget nf-widget-tags">
        <h4 class="nf-widget-title">Popular Topics</h4>
        <div class="nf-tags-cloud">
            <a href="/articles?tag=ai-banking" class="nf-tag">AI Banking</a>
            <a href="/articles?tag=tax" class="nf-tag">Tax Tips</a>
            <a href="/articles?tag=invoicing" class="nf-tag">Invoicing</a>
            <a href="/articles?tag=multi-currency" class="nf-tag">Multi-Currency</a>
            <a href="/articles?tag=freelance" class="nf-tag">Freelance</a>
            <a href="/articles?tag=expense-tracking" class="nf-tag">Expense Tracking</a>
        </div>
    </div>
</aside>
</div>