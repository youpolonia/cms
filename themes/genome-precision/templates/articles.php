...
<div class="atpl-wrap">
    ...
    <?php if (!empty($categories)): ?>
        <div class="gp-sidebar__block">
            <h4 class="gp-sidebar__title">
                <i class="fas fa-folder-open"></i>
                Categories
            </h4>
            <div class="gp-sidebar__categories">
                <?php foreach ($categories as $cat): ?>
                    <a href="/articles?category=<?= esc($cat['slug']) ?>" class="gp-sidebar__category">
                        <span class="gp-sidebar__category-name"><?= esc($cat['name']) ?></span>
                        <span class="gp-sidebar__category-count"><?= (int)($cat['article_count'] ?? 0) ?></span>
                    </a>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <div class="gp-sidebar__block">
        ...
        <form class="gp-sidebar__search">
            <input type="text" placeholder="Enter keywords..." class="gp-sidebar__search-input">
            <button type="submit" class="gp-sidebar__search-btn">
    ...
    <div class="gp-sidebar__block">
        ...
        <p class="gp-sidebar__about" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Explore the frontier of personalized medicine. Our blog delivers expert analysis on genomic research, health innovations, and the future of precision healthcare.')) ?>
        </p>
    </div>
    ...
    <div class="gp-sidebar__block">
        ...
        <div class="gp-sidebar__tags">
            <a href="#" class="gp-sidebar__tag">Genomics</a>
            <a href="#" class="gp-sidebar__tag">Precision Medicine</a>
            <a href="#" class="gp-sidebar__tag">Bioinformatics</a>
            <a href="#" class="gp-sidebar__tag">Clinical Trials</a>
            <a href="#" class="gp-sidebar__tag">Health Tech</a>
            <a href="#" class="gp-sidebar__tag">Genetic Counseling</a>
        </div>
    </div>
</aside>
</div>