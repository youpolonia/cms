...
<div class="atpl-wrap">
    ...
    <div class="atpl-widget">
        ...
        <form class="atpl-search-form" action="/articles" method="GET">
            <input type="text" name="search" placeholder="Author, title, or keyword..." class="atpl-search-input">
    ...
    <div class="atpl-widget">
        ...
        <p class="atpl-widget-desc" data-ts="sidebar.about">
            <?= esc(theme_get('sidebar.about', 'Insights on rare editions, manuscript preservation, and the stories behind our most coveted acquisitions.')) ?>
        </p>
    </div>
    ...
    <div class="atpl-widget">
        <h4 class="atpl-widget-title">
            ...
            Bibliophile's Digest
        </h4>
        <p>Receive monthly updates on new acquisitions, restoration notes, and exclusive viewing invitations.</p>
