...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Anton&amp;family=Outfit:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet">
...
<header class="site-header" id="siteHeader">
    <div class="header-container">
        ...
        <div class="header-actions">
            <a href="tel:<?= esc(theme_get('header.phone', '+441onal')) ?>" class="header-phone">
                <i class="fas fa-phone-alt"></i>
                <span data-ts="header.phone"><?= esc(theme_get('header.phone', 'Call Us')) ?></span>
            </a>
            ...
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p class="footer-tagline" data-ts="footer.description">
                        <?= esc(theme_get('footer.description', 'Over 23 years of excellence in paving and groundwork across Essex. Quality craftsmanship for commercial and residential projects.')) ?>
                    </p>
                    <div class="footer-social">
                        <a href="<?= esc(theme_get('social.instagram', '#')) ?>" aria-label="Instagram" data-ts-href="social.instagram"><i class="fab fa-instagram"></i></a>
                        <a href="<?= esc(theme_get('social.facebook', '#')) ?>" aria-label="Facebook" data-ts-href="social.facebook"><i class="fab fa-facebook-f"></i></a>
                        <a href="<?= esc(theme_get('social.linkedin', '#')) ?>" aria-label="LinkedIn" data-ts-href="social.linkedin"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                ...
                <div class="footer-services">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="#services" class="footer-link">Patios</a></li>
                ...
                <div class="footer-contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li>
                            ...
                            <a href="mailto:<?= esc(theme_get('contact.email', 'info@edispaving.co.uk')) ?>" data-ts="contact.email"><?= esc(theme_get('contact.email', 'info@edispaving.co.uk')) ?></a>
                        </li>
                        <li>
                            <i class="fas fa-phone-alt"></i>
                            <a href="tel:<?= esc(theme_get('contact.phone', '')) ?>" data-ts="contact.phone"><?= esc(theme_get('contact.phone', 'Call for Quote')) ?></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <div class="footer-badges">
                ...
                <span><i class="fas fa-check-circle"></i> Free Quotes</span>
            </div>
        </div>
    </div>
</footer>
