<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        @can('manage users')
        <div class="mt-8">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Role Management</h2>
            <form method="POST" action="{{ route('users.role.update', $user) }}" class="mt-6 space-y-6">
                @csrf
                <div>
