<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6 text-gray-900 dark:text-gray-100">
        ...
        <div class="mb-4 grid grid-cols-2 gap-2 text-sm">
            ...
            <div class="p-2 bg-gray-50 dark:bg-gray-700 rounded">
                <div class="text-gray-500 dark:text-gray-400">Bottlenecks</div>
                <div>{{ count($approvalStats['bottlenecks']) }}</div>
            </div>
        </div>
            ...
            @forelse($pendingApprovals as $approval)
                <div class="border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 last:pb-0">
                    <div class="flex justify-between items-start">
                        <div>
                            <h4 class="font-medium">{{ $approval->content->title }}</h4>
        ...
        <div class="mt-4 flex justify-end">
            <a href="{{ route('content-approvals.index') }}" class="text-sm text-blue-500 hover:text-blue-700 dark:hover:text-blue-400">
                View All →
            </a>
        </div>
    </div>
