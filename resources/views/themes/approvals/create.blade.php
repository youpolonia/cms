...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Create Approval Workflow</h1>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <form action="{{ route('theme-approvals.workflows.store') }}" method="POST">
            @csrf
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="required_approvers_count" id="required_approvers_count" min="0" value="0"
                               class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
