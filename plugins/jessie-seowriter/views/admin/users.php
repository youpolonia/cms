<?php /** SEO Writer Admin — Users */ ?>
<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>SEO Writer — Users</title>
<style>
...
<div class="top"><h1>🔍 SEO Writer — Users</h1><div class="nav"><a href="/admin/seowriter">Dashboard</a><a href="/admin/seowriter/users" class="active">Users</a><a href="/admin/seowriter/content">Content</a></div></div>
<table><thead><tr><th>ID</th><th>Email</th><th>Name</th><th>Projects</th><th>Content</th><th>Credits</th><th>Joined</th></tr></thead><tbody>
<?php foreach ($users as $u): ?>
<tr><td><?= $u['id'] ?></td><td><?= htmlspecialchars($u['email']) ?></td><td><?= htmlspecialchars($u['name'] ?? '') ?></td>
<td><?= $u['project_count'] ?></td><td><?= $u['content_count'] ?></td><td><?= $u['credits_remaining'] ?? 0 ?></td><td><?= substr($u['created_at'], 0, 10) ?></td></tr>
<?php endforeach; ?>
