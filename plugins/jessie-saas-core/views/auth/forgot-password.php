...
<title>Reset Password — Jessie AI</title>
...
<div class="auth-box">
    ...
    <?php if (!empty($success)): ?>
        <div class="success">
            ✅ If an account with that email exists, we sent a password reset link.<br>
            <small style="color:var(--muted)">Check your inbox and spam folder. The link expires in 1 hour.</small>
        </div>
    <?php else: ?>
        <form method="post" action="/saas/forgot-password">
