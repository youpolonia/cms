<?php /** Image Studio Admin — Users */ ?>
<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Image Studio — Users</title>
<style>
...
<div class="top"><h1>🖼️ Image Studio — Users</h1><div class="nav"><a href="/admin/imagestudio">Dashboard</a><a href="/admin/imagestudio/users" class="active">Users</a><a href="/admin/imagestudio/images">Images</a></div></div>
<table><thead><tr><th>ID</th><th>Email</th><th>Name</th><th>Images</th><th>Credits Spent</th><th>Credits Left</th><th>Joined</th></tr></thead><tbody>
<?php foreach ($users as $u): ?>
<tr><td><?= $u['id'] ?></td><td><?= htmlspecialchars($u['email']) ?></td><td><?= htmlspecialchars($u['name'] ?? '') ?></td>
<td><?= $u['image_count'] ?></td><td><?= $u['credits_spent'] ?></td><td><?= $u['credits_remaining'] ?? 0 ?></td><td><?= substr($u['created_at'], 0, 10) ?></td></tr>
<?php endforeach; ?>
<?php if (empty($users)): ?><tr><td colspan="7" style="text-align:center;color:#64748b">No users yet</td></tr><?php endif; ?>
</tbody></table>
</div></body></html>
