<?php /** Copywriter Admin — Users */ ?>
<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>AI Copywriter — Users</title>
<style>
...
<div class="top"><h1>✍️ AI Copywriter — Users</h1><div class="nav"><a href="/admin/copywriter">Dashboard</a><a href="/admin/copywriter/users" class="active">Users</a><a href="/admin/copywriter/content">Content</a></div></div>
<table><thead><tr><th>ID</th><th>Email</th><th>Name</th><th>Generations</th><th>Brands</th><th>Credits</th><th>Joined</th></tr></thead><tbody>
<?php foreach ($users as $u): ?>
<tr><td><?= $u['id'] ?></td><td><?= htmlspecialchars($u['email']) ?></td><td><?= htmlspecialchars($u['name'] ?? '') ?></td>
<td><?= $u['content_count'] ?></td><td><?= $u['brand_count'] ?></td><td><?= $u['credits_remaining'] ?? 0 ?></td><td><?= substr($u['created_at'], 0, 10) ?></td></tr>
<?php endforeach; ?>
