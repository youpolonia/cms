...
// Get setting ID from query string
$id = isset($_GET['id']) ? (int) $_GET['id'] : 0;

if ($id < 1) {
    header('Location: manage.php?error=' . urlencode('Invalid setting ID'));
    exit;
}
...
if ($viewData === null) {
    header('Location: manage.php?error=' . urlencode('Setting not found'));
    exit;
}
...
<main class="container">
    <?php require_once __DIR__ . '/../views/settings/edit.php'; ?>
</main>
